      ...
      <header className={`sticky top-0 z-50 border-b backdrop-blur-md ${isDarkMode ? 'bg-slate-900/80 border-slate-700' : 'bg-white/80 border-slate-200'} px-6 lg:px-10 py-4 shadow-sm`}>
        <div className="w-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a 
              href="https://github.com/vnatale52/docsearch/raw/main/resoluciones/Total de 942 Resoluciones emitidas por la CA y CP desde 01-2014  a  06-2026 .zip"
              ...
              title="Descargar Resoluciones sobre casos concretos - emitidas desde 01-2014 a 06-2026 - por la Comisión Arbitral y la Comisión Plenaria del Convenio Multilateral - en el Impuesto sobre los Ingresos Brutos"
            >
